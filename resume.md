...
<body>
    ...
    <thead>
      <tr>
        ...
        <td><strong><span style="font-size:18px"> Phone: XXX-XXX-XXXX <br> Email: <a href="mailto:sharman0075@gmail.com">sharman0075@gmail.com</a> </span></strong></td>
  ...
  <thead>
    <tr>
      <td style="width:50%; text-align:left;">
        <strong style="font-size:16px;">DevOps Engineer </strong><br>
        <strong style="font-size:16px;">DELL, Remote</strong> <br>
        <strong style="font-size:16px;">Responsibilities:</strong>
      </td>
      <td style="width:50%; text-align:right;">
        <strong style="font-size:16px;">Feb 2022 – Present </strong><br>
      </td>
      </tr>
  </thead>
</table>
  ...
  <thead>
    <tr>
      <td style="width:100%; text-align:left;">
        ...
        <li>Executed Role-Based Access Control (RBAC) strategies, precisely defining user permissions within Kubernetes clusters, ensuring least privilege access.
        </li>
        <li>
...
<table style="width:100%; margin:0 auto;">
  <thead>
    <tr>
      <td style="width:50%; text-align:left;">
        <strong style="font-size:16px;">DevOps Engineer </strong><br>
        <strong style="font-size:16px;">Torch.AI, Remote</strong> <br>
        <strong style="font-size:16px;">Responsibilities:</strong>
      </td>
      <td style="width:50%; text-align:right;">
        <strong style="font-size:16px;">July 2021 – Feb 2022 </strong><br>
      </td>
      </tr>
  </thead>
</table>
...
<table style="width:100%; margin:0 auto;">
  <thead>
    <tr>
      <td style="width:50%; text-align:left;">
        <strong style="font-size:16px;">Could/DevOps Engineer </strong><br>
        <strong style="font-size:16px;">SunPower Corp, Remote </strong> <br>
        <strong style="font-size:16px;">Responsibilities:</strong>
      </td>
      <td style="width:50%; text-align:right;">
        <strong style="font-size:16px;">June 2019 – July 2021 </strong><br>
      </td>
      </tr>
  </thead>
</table>
...
<table style="width:100%; margin:0 auto;">
  <thead>
    <tr>
      <td style="width:50%; text-align:left;">
        <strong style="font-size:16px;">AWS/DevOps Engineer </strong><br>
        <strong style="font-size:16px;">Northern Trust, Chicago, IL </strong> <br>
        <strong style="font-size:16px;">Responsibilities:</strong>
      </td>
      <td style="width:50%; text-align:right;">
        <strong style="font-size:16px;">Sept 2017 - May 2019 </strong><br>
      </td>
      </tr>
  </thead>
</table>
  ...
  <thead>
    <tr>
      <td style="width:100%; text-align:left;">
        ...
        <li>
        Experience in using TFS as a source code management tool and integrating it with different IDE's.
        Experience with Cassandra and other NoSQL databases.
        </li>
        <li>
        Built Chef Development workflow and best practices around configuration management as well as built a strong and diverse internal Chef community.
        </li>
        <li>
        ...
        <li>
        Documenting processes, issues, and solutions promptly.
        </li>
        <li>
        ...
        <li>
        Tracking the bugs in a project using Jira.
        </li>
        <li>
        ...
        <li>
        Have good experience in creating and maintaining Docker containers.
        </li>
        <li>
        ...
        <li>
        Creating change requests, work orders, and problem tickets using the BMC Remedy tool and getting approvals from higher officials.
        </li>
        <li>
        ...
        <li>
        Experience in automating applications using UrbanCode Deploy.
        </li>
        <li>
        Automated the front-ends platform into highly scalable, consistent, repeatable infrastructure using a high degree of automation like Chef, Ansible, Vagrant, Jenkins, and cloud Formation.
        </li>
        <li>
...
<table style="width:100%; margin:0 auto;">
  <thead>
    <tr>
      <td style="width:50%; text-align:left;">
        <strong style="font-size:16px;">Linux/DevOps Engineer </strong><br>
        <strong style="font-size:16px;">Hilton Hotels Worldwide, Memphis, TN </strong> <br>
        <strong style="font-size:16px;">Responsibilities:</strong>
      </td>
      <td style="width:50%; text-align:right;">
        <strong style="font-size:16px;">April 2015 – Aug 2017 </strong><br>
      </td>
      </tr>
  </thead>
</table>
...
<table style="width:100%; margin:0 auto;">
  <thead>
    <tr>
      <td style="width:50%; text-align:left;">
        <strong style="font-size:16px;">Linux System Admin </strong><br>
        <strong style="font-size:16px;">Hyla Mobile, Dallas, TX </strong> <br>
        <strong style="font-size:16px;">Responsibilities:</strong>
      </td>
      <td style="width:50%; text-align:right;">
        <strong style="font-size:16px;">Jan 2013 – March 2015 </strong><br>
      </td>
      </tr>
  </thead>
</table>
